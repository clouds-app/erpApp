...
var x=['./colorui/components/cu-custom.wxml','./pages/index/index.wxml','./pages/login/login.wxml'];d_[x[0]]={}
...
var oR=_mz(z,'image',['src',3,'style',1],[],e,s,gg)
_(xQ,oR)
_(oP,xQ)
var fS=_n('view')
...
var cW=_mz(z,'input',['focus',-1,'placeholder',9,'type',1],[],e,s,gg)
_(oV,cW)
_(fS,oV)
var oX=_n('view')
_rz(z,oX,'class',11,e,s,gg)
var lY=_mz(z,'input',['password',12,'placeholder',1,'type',2],[],e,s,gg)
_(oX,lY)
_(fS,oX)
_(oP,fS)
_(bO,oP)
...
var t1=_mz(z,'button',['class',16,'type',1],[],e,s,gg)
...
setCssToHead([])();setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:3900:1)",{path:"./app.wxss"})();

__wxAppCode__['app.wxss']=setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:3900:1)",{path:"./app.wxss"});    
